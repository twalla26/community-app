...
public class EditStudy extends AppCompatActivity {
    ...
    private String URL_Content_Study = "http://39.124.122.32:5000/study_plan/modify/";
    private String URL_Edit_Study = "http://39.124.122.32:5000/study_plan/modify/";
    private String URL_Delete_Study = "http://39.124.122.32:5000/study_plan/delete/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        URL_Content_Study = URL_Content_Study + String.format("%s/", ID);
        URL_Edit_Study = URL_Edit_Study + String.format("%s/", ID);
        URL_Delete_Study = URL_Delete_Study + String.format("%s/", ID);
    ...
    public void send_request_Server_Edit_Study() {
        ...
        class sendData extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids){
                try {
                    CookieJar cookieJar = new PersistentCookieJar(new SetCookieCache(), new SharedPrefsCookiePersistor(EditStudy.this));
                    ...
                    EditStudy.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
            ...
            public String getString(String key) {
                SharedPreferences prefs = EditStudy.this.getSharedPreferences("session", Context.MODE_PRIVATE);
            ...
            protected String doInBackground(Void... voids){
                try {
                    ...
                    if (response.contains("success")){
                        ...
                        Intent intent = new Intent(EditStudy.this, Study_activity.class);
                        intent.putExtra("id", ID);
                        startActivity(intent);
                    } else {
                        EditStudy.this.runOnUiThread(new Runnable() {
