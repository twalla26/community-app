...
public class ViewMeal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_meal_user);
        ...
        edit_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ViewMeal.this, EditMeal.class);
    ...
    public void send_request_Server_Content_Meal(String URL) {
        ...
        class sendData extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids){
                try {
                    CookieJar cookieJar = new PersistentCookieJar(new SetCookieCache(), new SharedPrefsCookiePersistor(ViewMeal.this));
                    ...
                    ViewMeal.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ...
                            comment_list.setLayoutManager(new LinearLayoutManager(ViewMeal.this));
            ...
            public String getString(String key) {
                SharedPreferences prefs = ViewMeal.this.getSharedPreferences("session", Context.MODE_PRIVATE);
