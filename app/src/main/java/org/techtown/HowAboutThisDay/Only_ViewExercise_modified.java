...
public class Only_ViewExercise_modified extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_exercise_modified);
    ...
    public void send_request_Server_Content_Exercise(String URL) {
        ...
        class sendData extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids){
                try {
                    CookieJar cookieJar = new PersistentCookieJar(new SetCookieCache(), new SharedPrefsCookiePersistor(Only_ViewExercise_modified.this));
                    ...
                    Only_ViewExercise_modified.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ...
                            comment_list.setLayoutManager(new LinearLayoutManager(Only_ViewExercise_modified.this));
            ...
            public String getString(String key) {
                SharedPreferences prefs = Only_ViewExercise_modified.this.getSharedPreferences("session", Context.MODE_PRIVATE);
