...
public class Only_ViewMeal_modified extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_meal_modified);
    ...
    public void send_request_Server_Content_Meal(String URL) {
        ...
        class sendData extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids){
                try {
                    CookieJar cookieJar = new PersistentCookieJar(new SetCookieCache(), new SharedPrefsCookiePersistor(Only_ViewMeal_modified.this));
                    ...
                    Only_ViewMeal_modified.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ...
                            comment_list.setLayoutManager(new LinearLayoutManager(Only_ViewMeal_modified.this));
            ...
            public String getString(String key) {
                SharedPreferences prefs = Only_ViewMeal_modified.this.getSharedPreferences("session", Context.MODE_PRIVATE);
