...
public class EditExercise extends AppCompatActivity {
    ...
    private String URL_Content_Exercise = "http://39.124.122.32:5000/exercise_plan/modify/";
    private String URL_Edit_Exercise = "http://39.124.122.32:5000/exercise_plan/modify/";
    private String URL_Delete_Exercise = "http://39.124.122.32:5000/exercise_plan/delete/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send_request_Server_Edit_Exercise();

        URL_Content_Exercise = URL_Content_Exercise + String.format("%s/", ID);
        URL_Edit_Exercise = URL_Edit_Exercise + String.format("%s/", ID);
        URL_Delete_Exercise = URL_Delete_Exercise + String.format("%s/", ID);
    ...
    public void send_request_Server_Edit_Exercise() {
        ...
        class sendData extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids){
                try {
                    CookieJar cookieJar = new PersistentCookieJar(new SetCookieCache(), new SharedPrefsCookiePersistor(EditExercise.this));
                    ...
                    EditExercise.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
            ...
            public String getString(String key) {
                SharedPreferences prefs = EditExercise.this.getSharedPreferences("session", Context.MODE_PRIVATE);
            ...
            protected String doInBackground(Void... voids){
                ...
                try {
                    ...
                    if (response.contains("success")){
                        ...
                        Intent intent = new Intent(EditExercise.this, ViewExercise_modified.class);
            ...
            protected String doInBackground(Void... voids){
                try {
                    ...
                    if (response.contains("success")){
                        ...
                        Intent intent = new Intent(EditExercise.this, ExerciseActivity.class);
                        intent.putExtra("id", ID);
                        startActivity(intent);
                    } else {
                        EditExercise.this.runOnUiThread(new Runnable() {
