...
def detail(plan_id): 
    ...
    comments = study_plan.study_plan_comment_set # plan_id에 해당하는 약속의 답변들을 answers에 저장
    return jsonify({"study_plan" : study_plan, "comments" : comments}) # 클라에 약속 데이터와 답변 데이터 전송
